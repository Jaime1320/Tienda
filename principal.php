        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    ?>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Insertar Productos</a>
                        </li>
                    <?php
                    }
                    ?>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                ?>
                    ...
                    <td><form action="" method="POST"><input class="btn btn-primary" type="submit" value="Añadir"</form></td>
